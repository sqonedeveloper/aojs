...
class EditorialTeam extends Component {
   constructor() {
      super()
                           ...
                           <div id="sj-content" className="sj-content">
                              <div className="sj-newsdetail">
                                 ...
                                 <div className="sj-description">
                                    {this.state.editUrl.editorial_team ? <button onClick={() => open(this.state.editUrl.editorial_team, '_blank')} className="live-edit-button"><i className="fas fa-edit" /> Edit</button> : ''}
                                    {renderHTML(this.state.editorial_team)}
                                 </div>
                              </div>
                           </div>
                        </Col>
...
ReactDOM.render(<EditorialTeam />, document.getElementById('root'))